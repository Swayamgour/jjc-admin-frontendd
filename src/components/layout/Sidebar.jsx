...
const NAV = [
  ...
  {
    section: "Resource Library", items: [
      { label: "Guides", path: "/guides", icon: <FileTextIcon /> },
      { label: "Checklists", path: "/checklists", icon: <ChecklistIcon /> },
      { label: "Whitepapers", path: "/whitepapers", icon: <PaperIcon /> },
    ]
  },
];
