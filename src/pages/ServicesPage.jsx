...
export default function ServicesPage() {
  ...
  const fields = useMemo(
    () => [
      ...
      },
      {
        ...
        type: "select",
        required: true,
        hint: "Choose which service group this belongs to",
      ...
      },
      {
        ...
        type: "textarea",
        rows: 4,
        placeholder: "Full intro paragraph for the service page",
        required: true,
      },
      {
        key: "hero",
        ...
        subFields: [
          {
            key: "metaTitle",
            label: "Meta Title",
            placeholder: "JJC Systems | Service Name",
          },
          {
            key: "metaDescription",
  ...
  return (
    <ContentPage
      title="Services"
      subtitle="Business-outcome service pages"
